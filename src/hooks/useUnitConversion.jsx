...
const useMetrics = (location) => {
  ...
  const windSpeed = convertWindSpeed(location.current.wind_speed_10m, isMetric);
  ...
  const metricsData = [
    {
      ...
      value: location.current.relative_humidity_2m,
      key: "humidity",
    },
    {
      label: "Wind",
    ...
    },
    {
      ...
      value: `(location.current.surface_pressure)}`,
      key: "pressure",
    },
    {
      label: "UV Index",
